...
describe('firing input events', () => {
  ...
  it('is oninput called on text', () => {
    ...
    const Component = component(
      'Component',
      () => <local.Observer>{state => <input type="text" oninput={change} value={state} /> }</local.Observer>,
    );
  ...
  it('is oninput called on number', () => {
    ...
    const Component = component(
      'Component',
      () => <local.Observer>{state => <input type="number" oninput={change} value={`${state}`} /> }</local.Observer>,
    );
  ...
  it('is oninput called on checkbox', () => {
    ...
    const Component = component(
      'Component',
      () => <local.Observer>{state => <input oninput={change} checked={state} type="checkbox" />}</local.Observer>,
    );
    ...
    const Component = component(
      ...
      () =>
        <local.Observer>{localState =>
          <input checked={localState} type="checkbox" oninput={evt => local.dispatch(evt.currentTarget.checked)} />
        }</local.Observer>,
    );
